...
@Component({
  selector: 'snails-system-httplog-list',
  templateUrl: './httplog-list.component.html',
  styleUrls: ['./httplog-list.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HttplogListComponent implements OnInit {
  ...
  search() {
    ...
    this.http.post('/httpLog/find', body, param).subscribe((res: any) => {
